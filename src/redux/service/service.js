...
export const GetArtwork = (queryParams) => useFetch("get", `/artwork?${queryParams}`);

export const GetArtworkById = (id) => useFetch("get", `/artwork/${id}`);

export const GetArtworkHistory = (id) => useFetch("get", `/artwork/${id}/history`);

export const PostArtwork = (data) => useFetch("post", "/artwork", data);

export const PatchArtwork = (id, data) => useFetch("patch", `/artwork/${id}`, data);
